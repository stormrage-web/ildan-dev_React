...
export default function Case({info}) {
    return (
      <li>
        <a href={info.href} className="work" style={{backgroundImage: "url(" + info.background + ")"}}>
          ...
          <div className="work-mask-number">
            ...
            <div className="work-mask-front">
              <div data-index={info.number} className="work-mask-overlay">{info.number}</div>
            </div>
          </div>
          <div className="work-text-section">
            <h3 itemProp="name" className="work-title">{info.title}</h3>
